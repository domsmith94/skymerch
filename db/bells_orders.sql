...
insert into customer_order(customer_id, order_date, delivery_type, order_status, total_price, house_no, address_line1, town_city, postcode)
     ...
     insert into order_line ( order_no, product_id, item_price, quantity_ordered, total_price)
      values ('3000007', '2000001', 4.99 , 4, 19.96);
      
       insert into order_line ( order_no, product_id, item_price, quantity_ordered, total_price)
      values ('3000007', '2000002', 3.99 , 1, 3.99);
      
insert into customer_order(customer_id, order_date, delivery_type, order_status, total_price, house_no, address_line1, town_city, postcode)
     values ('1000004', '2016-05-01 16:25:24', 'standard', 'dispatched', 35.93, 5, 'brimpsfield close abbeywood', 'london', 'SE2 9LR'); 
     
     insert into order_line ( order_no, product_id, item_price, quantity_ordered, total_price)
      values ('3000008', '2000001', 4.99 , 4, 19.96);
      
       insert into order_line ( order_no, product_id, item_price, quantity_ordered, total_price)
      values ('3000008', '2000002', 3.99 , 1, 3.99);
      
 insert into order_line ( order_no, product_id, item_price, quantity_ordered, total_price)
      values ('3000009', '2000005', 9.99 , 2, 18.98);