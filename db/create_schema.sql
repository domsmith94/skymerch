...
--      values ('April','Bennett', 'Mrs', 'april.bennett@sky.uk', 'Apple98', 32, 'round street', 'Greenwich', 'se16 9UV');
     ...
     values('James Bond Top Trumps', 10, 5, 3, 'The names Bond, James Bond. This pack needs no introduction, its simply the Best of Bond. It\'s the greatest adventure ever, so pay attention 007. Suitable for ages 3 years + Safety Information: Warning. Not suitable for Children under 3 years.', 4.9, 10, 2.99, 'toys');
     ...
     values('Game of Thrones Pin', 6, 8, 9, 'Become part of the Game Of Thrones story with this awesome Hand of the King pin! Beautifully crafted, this Hand of The King Pin is a replica of the one seen within the hit HBO series Game of Thrones. An ideal gift for any fan, this Game of thrones Hand Of The king pin measures 3-inches long x 1.1.4 inches wide.', 4.3, 4, 5.99, 'toys');
	   ...
	   insert into product(product_name, stock_level, stock_reorder_level, warehouse_location, product_description, product_rating, rating_count, product_price, product_category)
     values('Game of Thrones Babygrow', 4, 4, 5, 'This funny and unique Game of Thrones babygrow would make the perfect gift. It has an envelope neck opening with narrow self-bound neck and sleeve ends. The Game of Thrones print is on high quality cotton, the quirky design makes for a funny, adorable little baby outfit.', 4.7, 7, 22.99, 'clothing'); 

     insert into product(product_name, stock_level, stock_reorder_level, warehouse_location, product_description, product_rating, rating_count, product_price, product_category)
     values('Team Sky Jersey and Shorts', 7, 8, 2, 'Accept no compromises when supporting your favourite team. A jersey that proudly sports the 2016 colours of Team Sky, made from a breathable and wicking fabric.', 2.7, 1, 69.99, 'clothing');

     insert into product(product_name, stock_level, stock_reorder_level, warehouse_location, product_description, product_rating, rating_count, product_price, product_category)
     values('Sky Remote', 12, 7, 10, 'If you’re a Sky+HD box and TV customer, this popular Sky remote control will put stunning high definition back at your fingertips.', 3.5, 8, 19.99, 'electronics');

     insert into product(product_name, stock_level, stock_reorder_level, warehouse_location, product_description, product_rating, rating_count, product_price, product_category)
     values('Ghostbusters Phonecase', 6, 5, 6, 'Pefect for all ghostbusters fans! This original case gives you the perfect way to protect your mobile device as it is both flexible and impact-resistant.', 4.5, 3, 9.99, 'electronics');

     insert into product(product_name, stock_level, stock_reorder_level, warehouse_location, product_description, product_rating, rating_count, product_price, product_category)
     values('Shrek Ogre Ears Headband', 10, 3, 7, 'Ideal fancy dress accessory for the characters Shrek and Princess Fiona.', 3.8, 4, 3.99, 'clothing');

     insert into product(product_name, stock_level, stock_reorder_level, warehouse_location, product_description, product_rating, rating_count, product_price, product_category)
     values('Despicable Me Minion Bowling Set', 5, 3, 1, 'The Minions in this Despicable Me Bowling Set were made to be knocked over! Set up the six pins and go head-to-head with friends to see who`s got the strongest bowling arm. Each pin features a quirky Minion face so wind up and aim for a strike! This sporty set is ideal for indoor for outdoors play and any number of players. A great gift for three years and up.', 2.6, 6, 14.99, 'toys');
     ...
     insert into product(product_name, stock_level, stock_reorder_level, warehouse_location, product_description, product_rating, rating_count, product_price, product_category)
     values('Despicable Me Minions Watch', 9, 3, 12, 'Fun minions LCD watch with Minions graphics on straps.', 9.2, 6, 24.99, 'clothing');

     insert into product(product_name, stock_level, stock_reorder_level, warehouse_location, product_description, product_rating, rating_count, product_price, product_category)
     values('Disney Frozen Digital Camera', 8, 7, 14, 'Capture every fun moment and relive great memories with this Frozen Digital Camera. Compact size means you can take it anywhere - parties, days out, or hanging out with friends. ', 4.1, 4, 29.99, 'electronics');
